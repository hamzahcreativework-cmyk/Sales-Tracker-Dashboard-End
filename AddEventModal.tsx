        ...
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50 fade-in">
            <div className="bg-[var(--color-surface)] rounded-2xl shadow-xl max-w-2xl w-full p-6 sm:p-8 relative border border-[var(--color-border)] max-h-[90vh] flex flex-col">
                <div className="flex justify-between items-start mb-6 flex-shrink-0">
                    ...
                    <button onClick={handleClose} className="text-[var(--color-text-secondary)] hover:text-[var(--color-text-primary)] p-2 rounded-full hover:bg-gray-100 transition-colors">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5">
                     ...
                     <div className="flex space-x-4 mt-8 pt-6 border-t border-[var(--color-border)] flex-shrink-0">
                        <button type="button" onClick={handleClose} className="flex-1 px-4 py-2.5 border border-[var(--color-border)] text-[var(--color-text-secondary)] rounded-xl hover:bg-gray-50 font-semibold transition-colors">
                            Batal
                        </button>
